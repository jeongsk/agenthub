...
description: "UI와 인터랙션을 더 세련되게 만들 수 있도록 애니메이션, 모션 리뷰, 디자인 원칙을 제공하는 Emil Kowalski의 에이전트 스킬 모음입니다."
...
**Skills for Design Engineers**는 디자이너와 엔지니어가 더 나은 사용자 인터페이스를 만들도록 돕는 에이전트 스킬 모음입니다. Vercel과 Linear 등에서의 경험을 바탕으로, 에이전트가 애니메이션과 디자인을 결정할 때 놓치기 쉬운 디테일을 점검하고 더 빠르게 좋은 선택에 도달하도록 돕습니다.
