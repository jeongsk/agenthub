---
title: "Humanize KR"
description: "Claude Code에서 한국어 AI 문체를 자연스럽게 다듬는 스킬 번들입니다. 내용은 그대로 두고 번역투, 과한 접속사, 기계적인 불릿을 줄여 ‘사람이 쓴 것 같은’ 문장으로 바꾸고 싶을 때 유용합니다."
...
- Claude Code 안에서 한국어 윤문 워크플로를 표준화하고 싶을 때
...
- Claude Code 전용 스킬/커맨드 구조로 바로 적용하기 좋습니다.
